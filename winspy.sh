...
echo ""
echo -e "   	   	$Cyan         Author:$green @cyber_mrlinkerrorsystemoffical\e[0m$nc\n"
echo -e  "	      	\e[101m[+] Telegram : cardingtutorialfreeindonesia   [+]\e[0m"
echo -e  "	      	\e[101m[+] Email: developerpaceusa@gmail.com [+]\e[0m\n"
	}
function back() {
echo ""
